...
#if JUCE_WINDOWS
    static const String directorySeparater = "\\";
#elif JUCE_MAC
    static const String directorySeparater = "/";
#endif
    ...
    mProcessor(inProcessor)
{
    ...
    mPresetDirectory = (File::getSpecialLocation(File::userDesktopDirectory)).getFullPathName()+directorySeparater+pluginName;
